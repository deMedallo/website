			...
			<ul class="navbar-nav mt-2 mt-md-0">
				...
				-->
				 ...
				 <?php if(checkSession() == false){ ?>
					...
					<li class="nav-item"><a class="nav-link" href="<?php echo url_site; ?>/register.dm">Crear Cuenta</a></li>
				 <?php }else{
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
								...
								<?php foreach($demo->wallets As $symbol=>$data){
									...
									<fieldset class="dropdown-item">
										<label><?php echo $data->symbol; ?> - <?php echo $data->name; ?></label>
										<table class="table table-responsive">
											...
											<tr>
												<td><a href="lastTx.dm?address=<?php echo $data->address; ?>&coin=<?php echo $data->coin_id; ?>" class="btn btn-secondary">Transacciones</a></td>
												<td><a href="sendW.dm?coin=<?php echo $data->coin_id; ?>" class="btn btn-info">Enviar</a></td>
											</tr>
										</table>
